( function () {
	...
	const read = THREE.read;
    const KHR_DF_FLAG_ALPHA_PREMULTIPLIED = THREE.KHR_DF_FLAG_ALPHA_PREMULTIPLIED;
    const KHR_DF_PRIMARIES_BT709 = THREE.KHR_DF_PRIMARIES_BT709;
    const KHR_DF_PRIMARIES_DISPLAYP3 = THREE.KHR_DF_PRIMARIES_DISPLAYP3;
    const KHR_DF_PRIMARIES_UNSPECIFIED = THREE.KHR_DF_PRIMARIES_UNSPECIFIED;
    const KHR_DF_TRANSFER_SRGB = THREE.KHR_DF_TRANSFER_SRGB;
    const KHR_SUPERCOMPRESSION_NONE = THREE.KHR_SUPERCOMPRESSION_NONE;
    const KHR_SUPERCOMPRESSION_ZSTD = THREE.KHR_SUPERCOMPRESSION_ZSTD;
    const VK_FORMAT_ASTC_4x4_SFLOAT_BLOCK_EXT = THREE.VK_FORMAT_ASTC_4x4_SFLOAT_BLOCK_EXT;
    const VK_FORMAT_ASTC_4x4_SRGB_BLOCK = THREE.VK_FORMAT_ASTC_4x4_SRGB_BLOCK;
    const VK_FORMAT_ASTC_4x4_UNORM_BLOCK = THREE.VK_FORMAT_ASTC_4x4_UNORM_BLOCK;
    const VK_FORMAT_ASTC_6x6_SRGB_BLOCK = THREE.VK_FORMAT_ASTC_6x6_SRGB_BLOCK;
    const VK_FORMAT_ASTC_6x6_UNORM_BLOCK = THREE.VK_FORMAT_ASTC_6x6_UNORM_BLOCK;
    const VK_FORMAT_BC1_RGBA_SRGB_BLOCK = THREE.VK_FORMAT_BC1_RGBA_SRGB_BLOCK;
    const VK_FORMAT_BC1_RGBA_UNORM_BLOCK = THREE.VK_FORMAT_BC1_RGBA_UNORM_BLOCK;
    const VK_FORMAT_BC1_RGB_SRGB_BLOCK = THREE.VK_FORMAT_BC1_RGB_SRGB_BLOCK;
    const VK_FORMAT_BC1_RGB_UNORM_BLOCK = THREE.VK_FORMAT_BC1_RGB_UNORM_BLOCK;
    const VK_FORMAT_BC3_SRGB_BLOCK = THREE.VK_FORMAT_BC3_SRGB_BLOCK;
    const VK_FORMAT_BC3_UNORM_BLOCK = THREE.VK_FORMAT_BC3_UNORM_BLOCK;
    const VK_FORMAT_BC5_SNORM_BLOCK = THREE.VK_FORMAT_BC5_SNORM_BLOCK;
    const VK_FORMAT_BC5_UNORM_BLOCK = THREE.VK_FORMAT_BC5_UNORM_BLOCK;
    const VK_FORMAT_BC7_SRGB_BLOCK = THREE.VK_FORMAT_BC7_SRGB_BLOCK;
    const VK_FORMAT_BC7_UNORM_BLOCK = THREE.VK_FORMAT_BC7_UNORM_BLOCK;
    const VK_FORMAT_ETC2_R8G8B8_SRGB_BLOCK = THREE.VK_FORMAT_ETC2_R8G8B8_SRGB_BLOCK;
    const VK_FORMAT_ETC2_R8G8B8A8_SRGB_BLOCK = THREE.VK_FORMAT_ETC2_R8G8B8A8_SRGB_BLOCK;
    const VK_FORMAT_R16G16B16A16_SFLOAT = THREE.VK_FORMAT_R16G16B16A16_SFLOAT;
    const VK_FORMAT_R16G16_SFLOAT = THREE.VK_FORMAT_R16G16_SFLOAT;
    const VK_FORMAT_R16_SFLOAT = THREE.VK_FORMAT_R16_SFLOAT;
    const VK_FORMAT_R32G32B32A32_SFLOAT = THREE.VK_FORMAT_R32G32B32A32_SFLOAT;
    const VK_FORMAT_R32G32_SFLOAT = THREE.VK_FORMAT_R32G32_SFLOAT;
    const VK_FORMAT_R32_SFLOAT = THREE.VK_FORMAT_R32_SFLOAT;
    const VK_FORMAT_R8G8B8A8_SRGB = THREE.VK_FORMAT_R8G8B8A8_SRGB;
    const VK_FORMAT_R8G8B8A8_UNORM = THREE.VK_FORMAT_R8G8B8A8_UNORM;
    const VK_FORMAT_R8G8_SRGB = THREE.VK_FORMAT_R8G8_SRGB;
    const VK_FORMAT_R8G8_UNORM = THREE.VK_FORMAT_R8G8_UNORM;
    const VK_FORMAT_R8_SRGB = THREE.VK_FORMAT_R8_SRGB;
    const VK_FORMAT_R8_UNORM = THREE.VK_FORMAT_R8_UNORM;
    const VK_FORMAT_UNDEFINED = THREE.VK_FORMAT_UNDEFINED;
