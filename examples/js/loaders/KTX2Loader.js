( function () {
	...
	const CompressedArrayTexture = THREE.CompressedArrayTexture;
    const CompressedCubeTexture = THREE.CompressedCubeTexture;
    ...
    const RGBA_S3TC_DXT3_Format = THREE.RGBA_S3TC_DXT3_Format;
    const RGBA_ETC2_EAC_Format = THREE.RGBA_ETC2_EAC_Format;
	const R11_EAC_Format = THREE.R11_EAC_Format;
	const SIGNED_R11_EAC_Format = THREE.SIGNED_R11_EAC_Format;
	const RG11_EAC_Format = THREE.RG11_EAC_Format;
	const SIGNED_RG11_EAC_Format = THREE.SIGNED_RG11_EAC_Format;
    const RGBA_PVRTC_4BPPV1_Format = THREE.RGBA_PVRTC_4BPPV1_Format;
	const RGBA_PVRTC_2BPPV1_Format = THREE.RGBA_PVRTC_2BPPV1_Format;
    const RGBA_S3TC_DXT1_Format = THREE.RGBA_S3TC_DXT1_Format;
    const RGBA_S3TC_DXT5_Format = THREE.RGBA_S3TC_DXT5_Format;
    const RGB_BPTC_UNSIGNED_Format = THREE.RGB_BPTC_UNSIGNED_Format;
	...
	const SIGNED_RED_GREEN_RGTC2_Format = THREE.SIGNED_RED_GREEN_RGTC2_Format;
    const SIGNED_RED_RGTC1_Format = THREE.SIGNED_RED_RGTC1_Format;
    const RED_GREEN_RGTC2_Format = THREE.RED_GREEN_RGTC2_Format;
    const RED_RGTC1_Format = THREE.RED_RGTC1_Format;
	...
	const read = KTX.read;
    const KHR_DF_FLAG_ALPHA_PREMULTIPLIED = KTX.KHR_DF_FLAG_ALPHA_PREMULTIPLIED;
    const KHR_DF_PRIMARIES_BT709 = KTX.KHR_DF_PRIMARIES_BT709;
    const KHR_DF_PRIMARIES_DISPLAYP3 = KTX.KHR_DF_PRIMARIES_DISPLAYP3;
    const KHR_DF_PRIMARIES_UNSPECIFIED = KTX.KHR_DF_PRIMARIES_UNSPECIFIED;
    const KHR_DF_TRANSFER_SRGB = KTX.KHR_DF_TRANSFER_SRGB;
    const KHR_SUPERCOMPRESSION_NONE = KTX.KHR_SUPERCOMPRESSION_NONE;
    const KHR_SUPERCOMPRESSION_ZSTD = KTX.KHR_SUPERCOMPRESSION_ZSTD;
    const VK_FORMAT_ASTC_4x4_SFLOAT_BLOCK_EXT = KTX.VK_FORMAT_ASTC_4x4_SFLOAT_BLOCK_EXT;
	const VK_FORMAT_ASTC_6x6_SFLOAT_BLOCK_EXT = KTX.VK_FORMAT_ASTC_6x6_SFLOAT_BLOCK_EXT;
    const VK_FORMAT_ASTC_4x4_SRGB_BLOCK = KTX.VK_FORMAT_ASTC_4x4_SRGB_BLOCK;
    const VK_FORMAT_ASTC_4x4_UNORM_BLOCK = KTX.VK_FORMAT_ASTC_4x4_UNORM_BLOCK;
    const VK_FORMAT_ASTC_6x6_SRGB_BLOCK = KTX.VK_FORMAT_ASTC_6x6_SRGB_BLOCK;
    const VK_FORMAT_ASTC_6x6_UNORM_BLOCK = KTX.VK_FORMAT_ASTC_6x6_UNORM_BLOCK;
    const VK_FORMAT_BC1_RGBA_SRGB_BLOCK = KTX.VK_FORMAT_BC1_RGBA_SRGB_BLOCK;
    const VK_FORMAT_BC1_RGBA_UNORM_BLOCK = KTX.VK_FORMAT_BC1_RGBA_UNORM_BLOCK;
    const VK_FORMAT_BC1_RGB_SRGB_BLOCK = KTX.VK_FORMAT_BC1_RGB_SRGB_BLOCK;
    const VK_FORMAT_BC1_RGB_UNORM_BLOCK = KTX.VK_FORMAT_BC1_RGB_UNORM_BLOCK;
    const VK_FORMAT_BC3_SRGB_BLOCK = KTX.VK_FORMAT_BC3_SRGB_BLOCK;
    const VK_FORMAT_BC3_UNORM_BLOCK = KTX.VK_FORMAT_BC3_UNORM_BLOCK;
	const VK_FORMAT_BC4_SNORM_BLOCK = KTX.VK_FORMAT_BC4_SNORM_BLOCK;
    const VK_FORMAT_BC4_UNORM_BLOCK = KTX.VK_FORMAT_BC4_UNORM_BLOCK;
    const VK_FORMAT_BC5_SNORM_BLOCK = KTX.VK_FORMAT_BC5_SNORM_BLOCK;
    const VK_FORMAT_BC5_UNORM_BLOCK = KTX.VK_FORMAT_BC5_UNORM_BLOCK;
    const VK_FORMAT_BC7_SRGB_BLOCK = KTX.VK_FORMAT_BC7_SRGB_BLOCK;
    const VK_FORMAT_BC7_UNORM_BLOCK = KTX.VK_FORMAT_BC7_UNORM_BLOCK;
    const VK_FORMAT_ETC2_R8G8B8_SRGB_BLOCK = KTX.VK_FORMAT_ETC2_R8G8B8_SRGB_BLOCK;
    const VK_FORMAT_ETC2_R8G8B8A8_SRGB_BLOCK = KTX.VK_FORMAT_ETC2_R8G8B8A8_SRGB_BLOCK;
	const VK_FORMAT_EAC_R11_UNORM_BLOCK = KTX.VK_FORMAT_EAC_R11_UNORM_BLOCK;
	const VK_FORMAT_EAC_R11_SNORM_BLOCK = KTX.VK_FORMAT_EAC_R11_SNORM_BLOCK;
	const VK_FORMAT_EAC_R11G11_UNORM_BLOCK = KTX.VK_FORMAT_EAC_R11G11_UNORM_BLOCK;
	const VK_FORMAT_EAC_R11G11_SNORM_BLOCK = KTX.VK_FORMAT_EAC_R11G11_SNORM_BLOCK;
	const VK_FORMAT_PVRTC1_4BPP_SRGB_BLOCK_IMG = KTX.VK_FORMAT_PVRTC1_4BPP_SRGB_BLOCK_IMG;
    const VK_FORMAT_PVRTC1_4BPP_UNORM_BLOCK_IMG = KTX.VK_FORMAT_PVRTC1_4BPP_UNORM_BLOCK_IMG;
    ...
    const VK_FORMAT_R32G32_SFLOAT = KTX.VK_FORMAT_R32G32_SFLOAT;
    const VK_FORMAT_R32_SFLOAT = KTX.VK_FORMAT_R32_SFLOAT;
    const VK_FORMAT_R8G8B8A8_SRGB = KTX.VK_FORMAT_R8G8B8A8_SRGB;
    const VK_FORMAT_R8G8B8A8_UNORM = KTX.VK_FORMAT_R8G8B8A8_UNORM;
    const VK_FORMAT_R8G8_SRGB = KTX.VK_FORMAT_R8G8_SRGB;
    const VK_FORMAT_R8G8_UNORM = KTX.VK_FORMAT_R8G8_UNORM;
    const VK_FORMAT_R8_SRGB = KTX.VK_FORMAT_R8_SRGB;
    const VK_FORMAT_R8_UNORM = KTX.VK_FORMAT_R8_UNORM;
	const VK_FORMAT_E5B9G9R9_UFLOAT_PACK32 = KTX.VK_FORMAT_E5B9G9R9_UFLOAT_PACK32;
    const VK_FORMAT_B10G11R11_UFLOAT_PACK32 = KTX.VK_FORMAT_B10G11R11_UFLOAT_PACK32;
    const VK_FORMAT_UNDEFINED = KTX.VK_FORMAT_UNDEFINED;
